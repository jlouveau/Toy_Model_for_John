function [ new_exit_cells, B_cells_trial ] = GC_cycle( B_cells_trial, conc, activation_energy, threshold_energy, p_mut, p_CDR, p_FR_lethal, p_recycle, t_cell_selection, overlap, nb_Ag, energy_scale)
...
% 1st division + SHM
daughters1 = division_and_mutation(B_cells_trial, activation_energy, threshold_energy, p_mut, p_CDR, p_FR_lethal, overlap);

%2nd division + SHM
B_cells_trial = division_and_mutation(daughters1, activation_energy, threshold_energy, p_mut, p_CDR, p_FR_lethal, overlap);
