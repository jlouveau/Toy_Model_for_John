function [ pop_time, total_exit_cells, neutralized, breadth, average_energy, affinity ] = analysis( number_recycled_b_cells, number_exit_cells, exit_cells, n_trial_max, e_act, n_cycle_max, p_mut, p_recycle, t_cell_selection, conc, p_CDR)
